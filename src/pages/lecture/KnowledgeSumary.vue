<template>
  <div class="knowledge-sumary">
    <div class="tab">
      ...
      <span><i class="sidebar__sub-icon active"></i>我的知识总结</span>
    ...
    <div class="knowledge-sumary-content">
      <div class="point-tree-container">
        <knowledge-tree @change="handleNodeClick" ref="knowledgeTree" />
        <!-- <el-tree
          class="hi"
      ...
      <div class="point-explain-container">
        ...
        <div class="point-explain--edit" v-if="!initial&&!forView&&forEdit" key="forEdit">
          <el-form label-width="100px">
            <el-form-item label="知识总结：">
              <el-input ref="inputRef" type="textarea" :rows="4" v-model="originalContentCopy" placeholder="请输入知识总结"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getPointExplain () {
      lectureApi.getPointExplain({id: this.selectedPointData.nodeId, type: 'SUMMARY'}).then(res => {
    ...
    confirmEdit () {
      if (!this.originalContentCopy.trim()) {
        return this.$message.error('请填写知识总结!')
      }
